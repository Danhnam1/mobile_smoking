...
import {
  getProgressByStage,
  getTotalCigarettesInPeriod,
  getTotalMoneySpentInPeriod,
    ...
    try {
      ...
      if (user && token) {
        ...
        if (quitPlan) {
          ...
          let cigarettesAvoided =
            daysQuit * avgCigPerDay - totalCigarettesSmoked;
        ...
        console.log(
          "Skipping progress data fetch as user is not logged in or token is missing."
        );
        setProgressData({
          daysQuit: 0,
          cigarettesAvoided: 0,
      ...
      setBadgesError(
        "Failed to load data (badges or progress). Please check your connection and login status."
      );
      setLoadingBadges(false);
    }
  }, [user, token]);
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        >
          ...
          <View style={styles.card}>
            <View
              style={[styles.communityImage, styles.communityImagePlaceholder]}
            >
            ...
            <View style={[styles.card, styles.healthImprovementCard]}>
              ...
              <View style={styles.healthImprovementTextContainer}>
                ...
                <Text style={styles.upgradeDescription}>
                  Improve your health + Create your own goals + Unlimited access
                  to the community + Forg...
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.sectionContainer}>
            ...
            <View style={[styles.card, styles.quitPlanCard]}>
              ...
              <View style={styles.healthImprovementTextContainer}>
                ...
                <Text style={styles.upgradeDescription}>
                  Track your progress and follow your personalized quit plan...
                </Text>
              </View>
            </View>
          </View>
